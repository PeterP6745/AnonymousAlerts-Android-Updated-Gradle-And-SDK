 ...
 */
public class StandardLiteReportActivity extends Activity {

    final Context context = this;
    public static final String LOG_TAG = StandardLiteReportActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lite_report_layout);
        buildActionBar();
...
//        hasVideoFeature = Preferences.getBoolean(Config.HAS_VIDEO_FEATURE);
    ...
    private void initWidgets(){
        ...
        //init checkbox
        anonymousCheckbox = (CheckBox) findViewById(R.id.lite_anonymous_checkbox);
        isAnonymous = true;
    ...
    private void getSubmitterTask() {
        ...
        apiHelper.setOnErrorListener(new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Log.d("StandardLiteReportActivity","getRegionsTask() - bluedove-GetSubmitters - onFailure: "+error);
                errorLoadingReportSettings(0);
                submitterCompleted = true;
            }
        });
    ...
    private void getRegionsTask() {
        ...
        apiHelper.setOnErrorListener(new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Log.d("StandardLiteReportActivity","getRegionsTask() - bluedove-GetRegions - onFailure: "+error);
                errorLoadingReportSettings(1);
                regionCompleted = true;
            }
        });
    ...
    private void getBuildingTypesTask() {
        ...
        apiHelper.setOnErrorListener(new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Log.d("StandardLiteReportActivity","getBuildingTypesTask() - bluedove-GetSchoolType - onFailure: "+error);
                errorLoadingReportSettings(2);
                buildingTypeCompleted = true;
            }
        });
    ...
    private void getLocationTask(){
        ...
        apiHelper.setOnErrorListener(new com.android.volley.Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Log.d("StandardLiteReportActivity","getLocationTask() - bluedove-GetLocation - onFailure: "+error);
                errorLoadingReportSettings(5);
                locationCompleted = true;
            }
        });
    ...
    private void getSchoolBuildingsTask(final String bTypeId, final String bRegionId){
        ...
        apiHelper.setOnErrorListener(new com.android.volley.Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Log.d("StandardLiteReportActivity","getSchoolBuildingsTask() - bluedove-GetBuildingsByRegion - onFailure: "+error);
                errorLoadingReportSettings(3);
                buildingCompleted = true;
            }
        });
    ...
    private void getIncidentsTask(final String buildingId) {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (success) {
                        ...
                        incidentSpinner.setAdapter(new ArrayAdapter<String>(StandardLiteReportActivity.this,
                                        // android.R.layout.simple_spinner_dropdown_item,
                                        R.layout.custom_spinner,
                                        incidentList) {
                            @Override
        ...
        apiHelper.setOnErrorListener(new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Log.d("StandardLiteReportActivity","getIncidentsTask() - bluedove-GetIncidentsByBuilding - onFailure: "+error);
                errorLoadingReportSettings(4);
                incidentCompleted = true;
            }
        });
    ...
    private boolean validateReport() {
        ...
        try {
            ...
            LogUtils.debug("ReportCreation","validateReport():" +
                    "\nbuildingIsSelected = "+buildingIsSelected+
                    "\nincidentIsSelected = "+incidentIsSelected+
                    "\nmessageIsEntered = "+messageIsEntered);
            ...
            if (!buildingIsSelected || !messageIsEntered) {
                ...
                } else { //if all the scenarios are completed it will show the dialog to submit report
                    showSuccessAlert();
                    successful = true;
                }
            }
    ...
    private void validateNonAnonReport() {
        ...
        try {
            ...
            LogUtils.debug("ReportCreation","validateNonAnonReport():" +
                    "\nbuildingIsSelected = "+buildingIsSelected+
                    "\nincidentIsSelected = "+incidentIsSelected+
                    "\nmessageIsEntered = "+messageIsEntered);
            ...
            if (!buildingIsSelected || !messageIsEntered) {
                ...
                Log.d("testingIncidentSelected", "Incident Is not selected: "+showIncidentCategorySpinner);
                ...
                if(!emailIsFilled && !phoneIsFilled){
                    Log.d("Logictest", "email and phone message");
                    String error = getString(R.string.missing_email_phone);

                    showErrorAlert(error, getString(R.string.missing_info),
                    ...
                    showErrorAlert(error, getString(R.string.invalid_email),
                            getString(R.string.please_fill_out));
                    allComplete = false;
                }
                    ...
                    showErrorAlert(error, getString(R.string.invalid_phone),
                            getString(R.string.please_fill_out));
                    allComplete = false;
                }
    ...
    private void submitReportTask(final String naaName, final String naaEmail, final String naaPhone) {
        ...
        String anonymousToggle = isAnonymous ? "1" : "0";
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success) {
                        ...
                        Toast.makeText(getApplicationContext(), R.string.report_sent_success,
                                Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(getApplicationContext(), R.string.report_sent_fail,
                                Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    Toast.makeText(getApplicationContext(), R.string.error_try_again,
                            Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
            }
        ...
        apiHelper.setOnErrorListener(new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                LogUtils.debug("StandardLiteReportActivity","submitReportTask() - onFailure: "+error);
                progressDialog.dismiss();
                Toast.makeText(getApplicationContext(), R.string.error_try_again,
                        Toast.LENGTH_SHORT).show();
            }
    ...
    private void showPhotoAlert() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(
                StandardLiteReportActivity.this);
